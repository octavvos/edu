...
urlpatterns = [
    ...
    path("lessons/<uuid:lesson_id>/homework/", assignment_views.MentorHomeworkView.as_view(),
         name="mentor-lesson-homework"),
    ...
    path("quiz-results/groups/", quiz_views.MentorQuizResultsGroupsView.as_view(),
         name="mentor-quiz-results-groups"),
    path("quiz-results/groups/<uuid:group_id>/", quiz_views.MentorQuizResultsLeaderboardView.as_view(),
         name="mentor-quiz-results-leaderboard"),
    path("quiz-results/groups/<uuid:group_id>/students/<uuid:student_id>/",
         quiz_views.MentorQuizResultsStudentView.as_view(), name="mentor-quiz-results-student"),
    path("quiz-results/groups/<uuid:group_id>/attempts/<uuid:attempt_id>/",
         quiz_views.MentorQuizResultsAttemptView.as_view(), name="mentor-quiz-results-attempt"),
